...
r = sANS(SYMBOLS, FREQ)
enc_val, bit = r.encode('301120')
print(int(enc_val,2), bit)
print(r.decode(enc_val, bit))
d = sANSDecoder(SYMBOLS, FREQ)
print(d.decode(enc_val, bit))